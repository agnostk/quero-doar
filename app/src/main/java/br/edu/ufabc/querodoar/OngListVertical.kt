...
import br.edu.ufabc.querodoar.databinding.FragmentOngListVerticalBinding
import br.edu.ufabc.querodoar.databinding.OngListItemBinding
import br.edu.ufabc.querodoar.model.ONG

class OngListVertical : Fragment() {
    private lateinit var binding: FragmentOngListVerticalBinding
...
//            Log.d("APP", "Recycled holder at position ${holder.bindingAdapterPosition}")
    ...
    override fun onCreateView(
        ...
        binding = FragmentOngListVerticalBinding.inflate(inflater, container, false)
        return binding.root
    }
